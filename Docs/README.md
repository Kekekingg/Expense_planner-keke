[README.md](https://github.com/user-attachments/files/31157945/README.md)
# Expense Planner

A modern personal budget and expense-tracking app built with **React 19**, **TypeScript**, the `useReducer` hook, and the **Context API**. Define a budget, log expenses, filter them by category, and track how much of your budget you've spent — all persisted locally in the browser.
...
- **Swipe actions** — swipe an expense to update or delete it (via `react-swipeable-list`).
